# Please don't judge my Terraform too hard, I've not had the opportunity to use it before but I'm having fun, haha. -Bonnie
resource "random_password" "password" {
 for_each = var.users
 length = 16
 special = true
}
# Have to use random as terraform does not give Azure the ability to generate an initial password haha
